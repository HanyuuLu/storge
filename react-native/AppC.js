...
class TextBox extends Component
{
  ...
  {
    return (
      <View style={{ alignItems: "center", marginTop: 50, borderRadius: 20, borderColor: "black", borderBottomColor: "white", backgroundColor: "white", padding: 20 }}>
...
class JFetch extends Button
{
  ...
  onPress()
  {
    let url = "https://wakamiyaeve.github.io/resource/5.json";
    var res = fetch(url);
    Alert.alert(res);
  }
}
function ccf()
{
  ...
  Alert.alert("statusCode:" +
    fetch(url)
      ...
      .then((resJson) => { return resJson.title })
...
// class Hanyuu extends Component
{
  ...
  render()
  {
    return (
      <ScrollView>
        <View style={{ flex: 1, alignItems: "center", backgroundColor: "powderblue", height: 800 }}>
          ...
          <JFetch title="fetch" onPress={ccf} />
          <BlinkApp />
        </View>
      </ScrollView>
    );
